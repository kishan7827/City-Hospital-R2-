                  ...
                  <form onSubmit={handleSubmit} action method="post" className="php-email-form">
                    <div className="row">
                      <div className="col-md-6 form-group">
                        <input type="text"
                          ...
                          id="name"
                          placeholder="Your Name" onBlur={handleBlur} onChange={handleChange}
                          />
                      ...
                      <div className="col-md-6 form-group mt-3 mt-md-0">
                        <input type="email"
                          ...
                          name="email"
                          id="email"
                          placeholder="Your Email" onBlur={handleBlur} onChange={handleChange} />
                    ...
                    <div className="form-group mt-3">
                      <input type="text"
                        ...
                        name="subject"
                        id="subject"
                        placeholder="Subject" onBlur={handleBlur} onChange={handleChange} />
                    ...
                    <div className="form-group mt-3">
                      <textarea
                        ...
                        name="message"
                        rows={5}
                        placeholder="Message" required defaultValue={""} onBlur={handleBlur} onChange={handleChange} />
                      <p>{errors.massage && touched.massage ? errors.massage : ''}</p>
                    </div>
                    <div className="my-3">
